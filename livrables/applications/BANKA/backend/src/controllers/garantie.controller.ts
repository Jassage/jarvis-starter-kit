...
export async function create(req: AuthRequest, res: Response, next: NextFunction) {
  try {
    const garantie = await garantieService.createGarantie(req.params.id, req.body, req.user!.userId);
...
export async function update(req: AuthRequest, res: Response, next: NextFunction) {
  try {
    const garantie = await garantieService.updateGarantie(req.params.garantieId, req.body, req.user!.userId);
