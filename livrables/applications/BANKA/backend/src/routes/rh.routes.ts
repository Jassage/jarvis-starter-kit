...
import {
  ...
  createEmployeSchema, updateEmployeSchema,
  createContratSchema, createCongeSchema,
} from '../validation/rh.schemas';
...
router.post('/postes',             requireAuth, requireAdmin, validate(createPosteSchema), ctrl.createPoste);
router.put('/postes/:id',          requireAuth, requireAdmin, validate(updatePosteSchema), ctrl.updatePoste);
...
router.post('/employes',                     requireAuth, requireAdmin, validate(createEmployeSchema), ctrl.createEmploye);
router.put('/employes/:id',                  requireAuth, requireAdmin, validate(updateEmployeSchema), ctrl.updateEmploye);
...
router.post('/contrats',               requireAuth, requireSupervisor, validate(createContratSchema), ctrl.createContrat);
...
router.post('/conges',             requireAuth, requireSupervisor, validate(createCongeSchema), ctrl.createConge);
