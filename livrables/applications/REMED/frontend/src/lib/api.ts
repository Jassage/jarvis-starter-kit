...
export const api = axios.create({
  baseURL: process.env.NEXT_PUBLIC_API_URL || 'http://localhost:4011/api',
  withCredentials: true,
});

// Verrou partagé : évite qu'un refresh du layout (hydrate au montage) et un refresh
// déclenché par l'intercepteur sur une requête 401 concurrente ne se marchent dessus.
