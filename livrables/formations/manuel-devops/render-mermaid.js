...
// Palette alignee sur assets/style.css (vert de marque + neutres du manuel).
const THEME_VARIABLES = {
  primaryColor: "#e8f6ee",
  primaryBorderColor: "#2fa860",
...
async function main() {
  ...
  for (const fichier of fichiers) {
    ...
    for (const m of matches) {
      ...
      // le scoping de style de Mermaid (#02-xxx .node rect {...}) et retombe sur le fill noir
      // par defaut du SVG — bug reel rencontre et diagnostique sur le chapitre 2.
