...
Ce workspace est le Jarvis personnel de Jaslin. Il a été créé avec le Jarvis Starter Kit pour servir d'assistant IA personnel au quotidien.
...
Je m'appelle Jaslin, je suis haïtien, originaire de Gros-Morne et je vis actuellement à Pignon (avec des allers-retours entre les deux villes). J'ai un profil mixte : étudiant en sciences informatiques, développeur fullstack freelance (applications web et mobile, rémunéré au projet) et professeur de programmation.

Mes objectifs prioritaires actuels sont de développer et lancer mes solutions SaaS : une plateforme e-learning, un système de gestion hospitalière, un logiciel de gestion scolaire et une solution bancaire, tout en décrochant mes premiers clients.

À long terme, je veux devenir un entrepreneur technologique reconnu, transformer mes SaaS en produits rentables, bâtir un portefeuille de clients fidèles en Haïti et à l'international, et avoir un impact positif dans mon pays grâce à la technologie.

Le domaine où j'ai besoin du plus d'aide en ce moment : l'architecture et le développement de mes solutions SaaS (conception logicielle, bases de données, architecture multi-tenant, sécurité, scalabilité, stratégie de lancement).
